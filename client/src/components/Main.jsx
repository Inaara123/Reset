...
const Main = () => {
  ...
  return (
    <main className='grid-auto'> 
      <section className="text-7xl mt-[90px] ml-[30px] font-black text-justify max-w-[754px] max-md:text-4xl" style={{ color: "#15155F" }}>
      ...
      <div className='text-4xl font-bold mt-[-60px] ml-[30px] max-w-[800px]'>
      ...
      <div className='mt-[30px] ml-[30px] gap-[46px]'>
        <Button 
         onClick={handleClick}
        color="primary"
         className='w-[305px] h-[67px] rounded-[30px] text-[25px] grid-auto-fit bg-[#5233ED]'
        ...
        <Button color="primary" variant="bordered" className='ml-[50px] w-[305px] h-[67px] border-3 border-[#5233ED] text-[#5233ED] rounded-[30px] text-[25px] grid-auto-fit' style={{ Color: "#5233ED", font: "outfit", fontWeight: "600" }}>
          Contact us
        </Button>
      </div>
    </main>
