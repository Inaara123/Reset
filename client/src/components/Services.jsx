...
const Services = () => {
  return (
    ...
    <main >
      ...
      <video controls className="mt-[100px] ml-[100px] w-auto mr-[100px] h-[500px] aspect-video rounded-lg border bg-black sm:h-[300px] md:h-[350px] lg:h-[500px] xl:h-[600px]  xsm:h-[250px] 
    xsm:ml-[50px] 
    xsm:mr-[50px]"  />
      ...
      <div className='flex flex-row flex-wrap justify-center ml-[30px] mt-[50px] gap-[60px] mb-[100px]'>
        <div className='h-auto w-[420px] rounded-[30px] mx-[20px] shadow-3xl transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none' style={{ backgroundColor: "#4B2ED8" }}>
        ...
        <div className='h-auto w-[420px] rounded-[30px] mx-[20px] shadow-2xl transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none' style={{ backgroundColor: "#4B2ED8" }}>
        ...
        <div className='h-auto w-[420px] mx-[20px] rounded-[30px] shadow-2xl transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none' style={{ backgroundColor: "#4B2ED8" }}>
      ...
      {/* chiropractor session component */}
        <div className='mt-[50px] ml-[30px]  flex flex-col'>
          ...
          <div className='ml-[30px] mt-[30px]  flex flex-col'>
            <p className='font-semibold text-[28px] font-outfit text-justify mr-[170px] xsm:mr-[10px] sm:mr-[30px] md:mr-[60px] lg:mr-[170px] xl:mr-[180px] 2xl:mr-[190px]  '
            style={{color:"#2D1C82"}}>
