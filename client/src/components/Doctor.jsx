...
const Doctor = () => {
  return (
    <div className='ml-[30px] mt-[30px] grid-auto-fit'>
        ...
        sm:w-[600px] sm:h-[1000px]
        md:w-[800px] md:h-[1000px]
        lg:w-[1300px] lg:h-[700px]'
        ...
        <section >
            ...
            <div className='w-[300px] font-outfit flex h-[200px] ml-[1000px] mt-[200px] rounded-[30px] shadow-2xl transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none
                            sm:ml-[300px] sm:mt-[-150px]
                            md:ml-[400px] md:mt-[-130px]
                            lg:ml-[1000px] lg:mt-[200px] ' 
            style={{ backgroundColor: "#3A24A8" }}>
        ...
        <div className='w-[900px] mt-[200px] ml-[200px] h-[300px] rounded-[30px] sm:w-[550px] sm:ml-[30px] sm:h-[100px] md:w-[700px] md:h-[150px] md:ml-[50px] lg:w-[800px] lg:h-[300px] lg:ml-[200px]  '
        style={{backgroundColor:"#3A24A8"}}>
          <img src={exp}
          className='mt-[100px]  '/>
        </div>
        ...
        <div className='ml-[30px] mt-[80px] sm:mt-[200px] md:mt-[200px] lg:mt-[80px] '>
            ...
            <div className='flex flex-row flex-wrap  w-auto ml-[10px]  mt-[200px] gap-[40px] sm:gap-[60px] md:gap-[80x] lg:gap-[40px]'
            >
